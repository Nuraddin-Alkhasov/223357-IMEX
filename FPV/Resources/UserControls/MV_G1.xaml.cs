...
{
    public partial class MV_G1 : UserControl
    {
        public MV_G1()
        {
            InitializeComponent();
        ...
        private void GhostVisibility_Change(object sender, VariableEventArgs e)
        {
            if ((bool)e.Value)
            {
                ...
                Ghost.BeginAnimation(UIElement.OpacityProperty, SetOpacity(1)); 
            }
            else
            {
                //Ghost.Visibility = Visibility.Hidden;
                Ghost.BeginAnimation(UIElement.OpacityProperty, SetIOpacity(0));
            }
        }
        ...
        private DoubleAnimation SetIOpacity(Double _O)
        {
            return new DoubleAnimation
            {
                To = _O,
