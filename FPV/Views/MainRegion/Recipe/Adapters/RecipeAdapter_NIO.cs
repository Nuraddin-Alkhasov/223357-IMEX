...
namespace HMI.Views.MainRegion.Recipe
{
    ...
    [ExportAdapter("RecipeAdapter_NIO")]
    public class RecipeAdapter_NIO : AdapterBase
    {
        public IRecipeClass recipeClass;
        private ObservableCollection<RecipeFileInfo> recipeFiles;

        public RecipeAdapter_NIO()
        {
            this.recipeClass = ApplicationService.GetService<IRecipeService>().GetRecipeClass("NIO");
