...
namespace HMI.Diagnose
{
    ...
    public class HistoricalAlarmFilterAdapter : AdapterBase
    {
        ...
        private readonly ListCollectionView desiredGroups;
        private readonly ListCollectionView desiredClasses;
        private readonly ObservableCollection<AlarmStateFilterItem> desiredStates;
