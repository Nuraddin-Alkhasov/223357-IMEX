...
namespace HMI
{
    ...
    public class LoggingFilterAdapter : AdapterBase
    {
		...
		public LoggingFilterAdapter()
        {
			...
			foreach (ILoggingCategory cat in categories)
			{
                ...
                foreach (ILoggingEvent evt in events)
                {
                    ...
                    catEvents.Add(new EventFilterItem(eventNameWithServer, evt.LocalizedName));
                }
        ...
        /// </summary>
        public ObservableCollection<LoggingTimeSpanFilterItem> _TimeSpanFilterTypes;
        public ObservableCollection<LoggingTimeSpanFilterItem> TimeSpanFilterTypes
        {
            get { return _TimeSpanFilterTypes; }
            set
            {
                ObservableCollection<LoggingTimeSpanFilterItem> temp = new ObservableCollection<LoggingTimeSpanFilterItem>
                {
                    new LoggingTimeSpanFilterItem(LoggingTimeSpanFilterType.Today),
                    new LoggingTimeSpanFilterItem(LoggingTimeSpanFilterType.Yesterday),
                    new LoggingTimeSpanFilterItem(LoggingTimeSpanFilterType.ThisWeek),
                    new LoggingTimeSpanFilterItem(LoggingTimeSpanFilterType.LastWeek),
                    new LoggingTimeSpanFilterItem(LoggingTimeSpanFilterType.Custom)
                };
    ...
    public class CategoryFilterItem : INotifyPropertyChanged
    {
        ...
        private readonly LoggingFilterAdapter adapter;
        private readonly ObservableCollection<EventFilterItem> desiredEvents;
	...
	public class EventFilterItem : INotifyPropertyChanged
    {
		...
		public EventFilterItem(string name, string localizedText)
        {
            this.name = name;
            this.localizedText = localizedText;
        }
	...
	public class UserFilterItem
	{
		...
		private string name;
		private string fullName;
		private readonly string bothNames;
