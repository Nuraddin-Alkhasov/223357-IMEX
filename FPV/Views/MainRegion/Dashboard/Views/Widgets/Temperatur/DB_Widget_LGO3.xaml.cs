...
namespace HMI.Dashboard
{
    ...
    /// </summary>
    [ExportDashboardWidget("DB_Widget_LGO3", "Dashboard.Text29", "@Dashboard.Text11", 1, 1)]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class DB_Widget_LGO3 : View, INotifyPropertyChanged
    {
        private double _lastLecture;
        IVariableService VS = ApplicationService.GetService<IVariableService>();
        IVariable WM;

        public DB_Widget_LGO3()
        {
            InitializeComponent();

            WM = VS.GetVariable("IMEX.PLC.Blocks.Jumo CPU ModBus TCP.Daten mTRON T Ofen 6-10.Daten Recive.LGO 3.Ist Tepmeratur");
