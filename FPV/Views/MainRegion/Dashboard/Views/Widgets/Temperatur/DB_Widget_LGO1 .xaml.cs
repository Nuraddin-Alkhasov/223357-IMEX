...
namespace HMI.Dashboard
{
    ...
    /// </summary>
    [ExportDashboardWidget("DB_Widget_LGO1", "Dashboard.Text27", "@Dashboard.Text11", 1, 1)]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class DB_Widget_LGO1 : View, INotifyPropertyChanged
    {
        private double _lastLecture;
        IVariableService VS = ApplicationService.GetService<IVariableService>();
        IVariable WM;

        public DB_Widget_LGO1()
        {
            InitializeComponent();

            WM = VS.GetVariable("IMEX.PLC.Blocks.Jumo CPU ModBus TCP.Daten mTRON T Ofen 1-5.Daten Recive.LGO 1.Ist Tepmeratur");
