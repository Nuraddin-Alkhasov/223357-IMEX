...
namespace HMI.Dashboard
{
    ...
    /// </summary>
    [ExportDashboardWidget("DB_Widget_ALO7", "Dashboard.Text26", "@Dashboard.Text11", 1, 1)]
    [PartCreationPolicy(CreationPolicy.NonShared)]
    public partial class DB_Widget_ALO7 : View, INotifyPropertyChanged
    {
        private double _lastLecture;
        IVariableService VS = ApplicationService.GetService<IVariableService>();
        IVariable WM;

        public DB_Widget_ALO7()
        {
            InitializeComponent();

            WM = VS.GetVariable("IMEX.PLC.Blocks.Jumo CPU ModBus TCP.Daten mTRON T Ofen 6-10.Daten Recive.ALO 7.Ist Tepmeratur");
