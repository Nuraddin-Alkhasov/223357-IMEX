...
namespace HMI
{
    ...
    public class DialogAdapter : AdapterBase
    {
        ...
        public DialogAdapter()
        {
            ...
            this.CloseDialogCommand2 = new ActionCommand(OnDialogClosingCommand2);
        }
            ...
            if (dbParams != null)
            {
                ...
                switch (this.Type)
                {
                    case InternalDialogButtons.OK:
                        ...
                        this.MiddleButtonIsDefault = (dbParams.DefaultResult == InternalDialogResult.OK);
                    ...
                    case InternalDialogButtons.OKCancel:
                        ...
                        this.LeftButtonText = "";
                        this.LeftButtonIsDefault = (dbParams.DefaultResult == InternalDialogResult.OK);
                        ...
                        this.RightButtonIsDefault = (dbParams.DefaultResult == InternalDialogResult.Cancel);
                        this.CancelButtonVisible = Visibility.Collapsed;
                        break;
                    ...
                    case InternalDialogButtons.YesNo:
                        ...
                        this.LeftButtonText = "";
                        this.LeftButtonIsDefault = (dbParams.DefaultResult == InternalDialogResult.Yes);
                        this.MiddleButtonVisible = Visibility.Collapsed;
                        this.RightButtonVisible = Visibility.Visible;
                        this.RightButtonLocalizableText = "@[ClientSystem].Dialogs.Common.cmdNo";
                        this.RightButtonText = "";
                        this.RightButtonIsDefault = (dbParams.DefaultResult == InternalDialogResult.No);
                        this.CancelButtonVisible = Visibility.Collapsed;
                        break;
                    ...
                    case InternalDialogButtons.YesNoCancel:
                        ...
                        this.MiddleButtonText = "";
                        this.MiddleButtonIsDefault = (dbParams.DefaultResult == InternalDialogResult.No);
                        this.RightButtonVisible = Visibility.Visible;
                        this.RightButtonLocalizableText = "@[ClientSystem].Dialogs.Common.cmdCancel";
                        this.RightButtonText = "";
                        this.RightButtonIsDefault = (dbParams.DefaultResult == InternalDialogResult.Cancel);
                    ...
                    case InternalDialogButtons.Custom:
                        ...
                        else
                        {
                            ...
                            this.LeftButtonIsDefault = (dbParams.DefaultResult == InternalDialogResult.Left);
                        }
                        ...
                        else
                        {
                            ...
                            this.MiddleButtonIsDefault = (dbParams.DefaultResult == InternalDialogResult.Middle);
                        }
                        ...
                        else
                        {
                            ...
                            this.RightButtonIsDefault = (dbParams.DefaultResult == InternalDialogResult.Right);
                        }
        ...
        public ICommand CloseDialogCommand2 { get; set; }

        public void OnDialogClosingCommand2(object parameter)
        {
            if (Content != "User_AddChangeUser" && Content != "User_AddChangeGroup")
        ...
        public void OnDialogClosingCommand(object parameter)
        {
            switch (Type)
            {
                case InternalDialogButtons.OK:
